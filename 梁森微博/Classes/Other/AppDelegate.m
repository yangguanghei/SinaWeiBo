...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // 看是否已经授权
    if ([LSAccountTool account]) { // 如果已经授权
        
        [LSRootTool chooseRootViewController:self.window];
        
    } else
    {
        LSOAuthViewController * oauthVC = [[LSOAuthViewController alloc] init];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "youshiguang.____" in the application's documents directory.
